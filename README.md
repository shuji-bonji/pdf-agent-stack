...
| [pdf-verify-mcp](https://github.com/shuji-bonji/pdf-verify-mcp) | judgment | mcp-server | 0.14.2 | `@shuji-bonji/pdf-verify-mcp` |
...
| [normativepdf](https://github.com/shuji-bonji/normativepdf) | action | library | 0.1.0 | — |
