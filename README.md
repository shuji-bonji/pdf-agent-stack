...
| リポジトリ | 役割 | 配布形態 | 版 | npm |
| --- | --- | --- | --- | --- |
| [pdf-spec-mcp](https://github.com/shuji-bonji/pdf-spec-mcp) | canon | mcp-server | 0.6.1 | `@shuji-bonji/pdf-spec-mcp` |
| [pdf-reader-mcp](https://github.com/shuji-bonji/pdf-reader-mcp) | structure | mcp-server | 0.15.5 | `@shuji-bonji/pdf-reader-mcp` |
| [pdf-verify-mcp](https://github.com/shuji-bonji/pdf-verify-mcp) | judgment | mcp-server | 0.29.1 | `@shuji-bonji/pdf-verify-mcp` |
| [pdf-writer-mcp](https://github.com/shuji-bonji/pdf-writer-mcp) | action | mcp-server | 0.21.2 | `@shuji-bonji/pdf-writer-mcp` |
...
| [pdf-trust-skill](https://github.com/shuji-bonji/pdf-trust-skill) | procedure | skill | 0.8.2 | — |
| [pdf-publish-skill](https://github.com/shuji-bonji/pdf-publish-skill) | procedure | skill | 0.7.1 | — |
| [pdf-read-skill](https://github.com/shuji-bonji/pdf-read-skill) | procedure | skill | 0.2.2 | — |
