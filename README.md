...
> 版は実測（2026-08-25 時点の `npm view`）。

| リポジトリ | 役割 | 配布形態 | 版 | npm |
| --- | --- | --- | --- | --- |
| [pdf-spec-mcp](https://github.com/shuji-bonji/pdf-spec-mcp) | canon | mcp-server | 0.5.0 | `@shuji-bonji/pdf-spec-mcp` |
| [pdf-reader-mcp](https://github.com/shuji-bonji/pdf-reader-mcp) | structure | mcp-server | 0.12.0 | `@shuji-bonji/pdf-reader-mcp` |
| [pdf-verify-mcp](https://github.com/shuji-bonji/pdf-verify-mcp) | judgment | mcp-server | 0.17.0 | `@shuji-bonji/pdf-verify-mcp` |
...
| [normativepdf](https://github.com/shuji-bonji/normativepdf) | action | library | 0.8.0 | `normativepdf` |
