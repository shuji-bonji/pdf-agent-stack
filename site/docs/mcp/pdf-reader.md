...
- npm: [`@shuji-bonji/pdf-reader-mcp`](https://www.npmjs.com/package/@shuji-bonji/pdf-reader-mcp) / current v0.13.0 / [GitHub](https://github.com/shuji-bonji/pdf-reader-mcp)
