...
- npm: [`@shuji-bonji/pdf-verify-mcp`](https://www.npmjs.com/package/@shuji-bonji/pdf-verify-mcp) / current v0.21.0 / [GitHub](https://github.com/shuji-bonji/pdf-verify-mcp)
