...
|---|---|---|---|---|
| [pdf-spec-mcp](/mcp/pdf-spec) | Canon | 0.6.1 | 8 | What the specification requires |
| [pdf-reader-mcp](/mcp/pdf-reader) | Substance | 0.15.5 | 19 | The content, and **where it is drawn** |
| [pdf-verify-mcp](/mcp/pdf-verify) | Authenticity & conformance | 0.29.1 | 7 | Is the signature valid, and does it meet the standard |
| [pdf-writer-mcp](/mcp/pdf-writer) | Creation | 0.21.2 | 20 | Written the way the spec says |
