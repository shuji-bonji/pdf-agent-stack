...
pdf-spec-mcp が返す「条文・要件・定義」を正しく解釈するには、ISO 規格に共通する文書規約を少し知っておく必要があります。このページは PDF Family を使ううえで必要な最小限だけをまとめた入門です。
...
- **適合性の議論で効くのは shall だけ**です。should 違反を「仕様違反」と書かないこと
