...
| [pdf-reader-mcp](/ja/mcp/pdf-reader) | 実体 | 0.15.0 | 19 | 中身に何があるか・**それはどこか** |
| [pdf-verify-mcp](/ja/mcp/pdf-verify) | 真正性・準拠性 | 0.26.0 | 7 | 本物で規格に適っているか |
...
引数・型・既定値は各サーバーの[ツールリファレンス](/ja/reference/mcp/pdf-spec)（`tools/list` から自動生成）にあります。解説ページはそこへ誘導するだけで、同じ表を持ちません。
:::
