...
| [pdf-reader-mcp](/ja/mcp/pdf-reader) | 実体           | 0.15.1 | 19       | 中身と、**その描画位置**を返す   |
| [pdf-verify-mcp](/ja/mcp/pdf-verify) | 真正性・準拠性 | 0.28.0 | 7        | 署名が有効か、規格に適っているか |
| [pdf-writer-mcp](/ja/mcp/pdf-writer) | 生成           | 0.21.1 | 20       | 仕様通りに書けるか               |
