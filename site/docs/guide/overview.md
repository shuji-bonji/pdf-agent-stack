---
description: The big picture of PDF Agent Stack — four MCP servers, three Skills, and why observation, judgment, creation and norms are kept apart
---

# What is PDF Agent Stack?

PDF Agent Stack is the collective name for four independent [MCP](/reference/glossary#base-vocabulary-of-this-site-ai-engineering) servers and three [Skills](/reference/glossary#base-vocabulary-of-this-site-ai-engineering) that give AI agents the ability to **read, verify, and write PDFs — grounded in the spec**.

## Components

| Kind | Name | Role | Distribution |
|---|---|---|---|
| MCP | [pdf-spec-mcp](/mcp/pdf-spec) | Consult the PDF specification (ISO 32000 and 16 more documents) | [npm](https://www.npmjs.com/package/@shuji-bonji/pdf-spec-mcp) · [GitHub](https://github.com/shuji-bonji/pdf-spec-mcp) |
| MCP | [pdf-reader-mcp](/mcp/pdf-reader) | Observe a PDF's internal state (19 observation tools) | [npm](https://www.npmjs.com/package/@shuji-bonji/pdf-reader-mcp) · [GitHub](https://github.com/shuji-bonji/pdf-reader-mcp) |
...
- [pdf-constraints](/reference/pdf-constraints) — the data library behind pdf-verify's clause checking, transcribing ISO 32000 clauses into machine-checkable constraint tables. Usable on its own, including as a CLI in CI
- [normativepdf](https://github.com/shuji-bonji/normativepdf) — the PDF library pdf-writer writes through, in which every behaviour is tied to an ISO 32000 clause
