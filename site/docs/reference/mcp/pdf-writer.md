---
description: "Tools reference for pdf-writer-mcp v0.21.1 — parameters, types, defaults and returns of all 20 tools, generated from the server's tools/list."
---
...
::: info
Auto-generated from the `tools/list` handshake of **v0.21.1** (20 tools, 2026-09-18). Do not edit by hand — regenerate with `node scripts/generate-reference.mjs`.
:::
