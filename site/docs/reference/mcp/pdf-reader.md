---
description: "Tools reference for pdf-reader-mcp v0.15.5 — parameters, types, defaults and returns of all 19 tools, generated from the server's tools/list."
---
...
::: info
Auto-generated from the `tools/list` handshake of **v0.15.5** (19 tools). Do not edit by hand — regenerate with `node scripts/generate-reference.mjs`.
:::
