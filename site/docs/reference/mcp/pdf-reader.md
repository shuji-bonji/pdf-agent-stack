---
description: "Tools reference for pdf-reader-mcp v0.15.1 — parameters, types, defaults and returns of all 19 tools, generated from the server's tools/list."
---
...
::: info
Auto-generated from the `tools/list` handshake of **v0.15.1** (19 tools, 2026-09-16). Do not edit by hand — regenerate with `node scripts/generate-reference.mjs`.
:::
