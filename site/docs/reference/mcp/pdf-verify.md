---
description: "Tools reference for pdf-verify-mcp v0.15.0 — parameters, types, defaults and returns of all 7 tools, generated from the server's tools/list."
---
...
::: info
Auto-generated from the `tools/list` handshake of **v0.15.0** (7 tools, 2026-08-13). Do not edit by hand — regenerate with `node scripts/generate-reference.mjs`.
:::
