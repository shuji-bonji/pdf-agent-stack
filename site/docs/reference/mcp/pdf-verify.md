---
description: "Tools reference for pdf-verify-mcp v0.14.2 — parameters, types, defaults and returns of all 7 tools, generated from the server's tools/list."
---
...
::: info
Auto-generated from the `tools/list` handshake of **v0.14.2** (7 tools, 2026-08-11). Do not edit by hand — regenerate with `node scripts/generate-reference.mjs`.
:::
